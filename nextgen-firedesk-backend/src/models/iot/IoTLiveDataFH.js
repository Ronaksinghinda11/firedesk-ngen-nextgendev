...
/**
 * IoT Live Data Model for Fire Hydrant Category
 * Stores real-time IoT data for fire hydrant devices
 */
const IoTLiveDataFH = sequelize.define(
    "IoTLiveDataFH",
    {
        id: {
            type: DataTypes.UUID,
    ...
    },
    {
        ...
        hooks: {
            beforeSave: (instance) => {
                ...
                // Fire Hydrant specific sensor keys (customize as needed)
                const keys = [
                    "PRESSURE",
                    "FLOW_RATE",
                    "STATUS",
