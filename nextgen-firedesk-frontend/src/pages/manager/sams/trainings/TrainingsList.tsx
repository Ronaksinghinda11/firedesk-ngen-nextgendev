...
import { managerApi, Training } from '@/services/api/samsApi';
...
const TrainingsList = () => {
  ...
  const fetchTrainings = async () => {
    try {
      ...
      const response = await managerApi.trainings.getAll(params);
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
            ...
            Trainings (Page Under Development)
          </h1>
          <p className="text-gray-600 mt-1">Schedule and manage safety trainings</p>
        </div>
        <Button onClick={() => navigate('/manager/sams/trainings/create')}>
                  ...
                  <TableRow key={training.id} className="cursor-pointer hover:bg-gray-50">
                    ...
                    <TableCell>
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => navigate(`/manager/sams/trainings/${training.id}`)}
                      >
                        View
                      </Button>
                    </TableCell>
