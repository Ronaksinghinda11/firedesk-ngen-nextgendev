              ...
              <table className="w-max min-w-full text-left text-sm border-collapse table-fixed">
                <thead className="sticky top-0 z-20 shadow-sm">
                  <tr className="bg-gray-100 text-[11px] font-bold text-gray-600 uppercase tracking-wider divide-x divide-gray-200 border-b border-gray-300">
                    <th className="px-4 py-3 sticky left-0 z-30 bg-gray-100 border-r border-gray-300 min-w-[300px] w-[400px]">Question Text</th>
                    <th className="px-4 py-3 w-[160px]">Category</th>
                    <th className="px-4 py-3 w-[200px]">Products</th>
                    <th className="px-4 py-3 w-[200px]">Frequencies</th>
                    <th className="px-4 py-3 w-[130px]">Service Type</th>
                    <th className="px-4 py-3 min-w-[250px] w-[350px]">Help Text</th>
                    <th className="px-4 py-3 w-[220px]">Condition</th>
                    <th className="px-4 py-3 w-24 text-center">Required</th>
                    <th className="px-4 py-3 w-24 text-center">Photo</th>
                    <th className="px-4 py-3 w-[100px]">Standard</th>
                    ...
                    <React.Fragment key={plantName}>
                      ...
                      {rows.map((row) => (
                        <tr key={`q-${row.id}`} className="hover:bg-orange-50/50 transition-colors group divide-x divide-gray-100">
                          <td className="px-4 py-3 align-top sticky left-0 z-10 bg-white group-hover:bg-orange-50/50 border-r border-gray-200 text-gray-900 font-semibold whitespace-normal">
                ...
                <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="space-y-1.5">
                      ...
                      <MultiSelect options={plantOptions} selected={pdfPlantFilter} onChange={setPdfPlantFilter} placeholder="All Plants" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-600 uppercase tracking-wider ml-1">Category</label>
                      <MultiSelect options={categoryOptions} selected={pdfCategoryFilter} onChange={setPdfCategoryFilter} placeholder="All Categories" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-600 uppercase tracking-wider ml-1">Product</label>
                      <MultiSelect options={productOptions} selected={pdfProductFilter} onChange={setPdfProductFilter} placeholder="All Products" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-600 uppercase tracking-wider ml-1">Frequency</label>
                      <MultiSelect options={freqOptions} selected={pdfFrequencyFilter} onChange={setPdfFrequencyFilter} placeholder="All Frequencies" />
                    </div>
                    <div className="space-y-1.5">
