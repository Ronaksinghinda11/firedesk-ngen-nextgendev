 ...
 * 
 * Modern, professional modal for generating maintenance reports
 * Features: Date range presets, enhanced UX, clean modern design
 */
...
import { CalendarIcon, Download, X, FileText, Clock, CheckCircle2, Sparkles } from 'lucide-react';
...
// Helper Date Picker Component (Orange Theme)
...
const availableColumns = [
    ...
    { id: 'building', label: 'Building', category: 'Asset Details' },
    { id: 'category', label: 'Category', category: 'Asset Details' },
    ...
    { id: 'completedAt', label: 'Completed Date', category: 'Dates' }
];
...
export function GenerateReportModal({
    ...
    const [selectedColumns, setSelectedColumns] = useState<string[]>(['assetId', 'status', 'technician', 'createdAt']);
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            // Fix filename
            const filename = `Maintenance_Report_${formattedStartDate}_to_${formattedEndDate}.pdf`;
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-emerald-700 dark:text-emerald-300">
                                        Your PDF will include maintenance data from {format(startDate, 'MMM d, yyyy')} to {format(endDate, 'MMM d, yyyy')}
